        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Planet>().HasData(
                new Planet
                {
                    ...
                    MassKilograms = Convert.ToDouble((0.33d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    Name = "Venus",
                    DiameterMiles = 7521,
                    MassKilograms = Convert.ToDouble((4.867d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    Name = "Earth",
                    DiameterMiles = 7926,
                    MassKilograms = Convert.ToDouble((5.972d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    MassKilograms = Convert.ToDouble((0.65d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    Name = "Jupiter",
                    DiameterMiles = 88846,
                    MassKilograms = Convert.ToDouble((1900d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    MassKilograms = Convert.ToDouble((570d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    MassKilograms = Convert.ToDouble((87d)*(10^24)),
                ...
                new Planet
                {
                    ...
                    MassKilograms = Convert.ToDouble((100d)*(10^24)),
